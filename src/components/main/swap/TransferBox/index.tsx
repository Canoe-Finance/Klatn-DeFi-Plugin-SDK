...
export class TransferBox {
  ...
  @State() fromChain: string = 'Klaytn'
  @State() toChain: string = 'WEMIX'
  ...
  handleBalanceMax = () => {
    if (Number(this.balance) > 0) {
      ...
      if (state.chain.chainId === 8217 && this.token.address === '' && Number(this.balance) > 0.01) {
  ...
  handleTransfer = async () => {
    try {
      ...
      if (method == 'anySwapOutNative') {
        ...
        await tx.wait()
        this.getBalance()
        this.href = 'https://scope.klaytn.com/tx/' + tx.hash
  ...
  handleSelect = async ({ detail }) => {
    ...
    this.receiveAmount = ''
    this.getBalance()
    this.checkApprove(window['ethereum'].selectedAddress)
  }
          ...
          <div class="flex-1">
            <div class="flex items-center justify-between mb-2">
              <div class="flex items-center">
                <label>From</label>
                <div class="chain-select flex items-center">
                  <img src="https://assets.coingecko.com/coins/images/9672/small/klaytn.png" alt="" />
            ...
            <div class="flex items-center my-2 relative pl-6">
              ...
              <label>To</label>
              <div class="chain-select flex items-center">
                <img src="https://assets.coingecko.com/coins/images/12998/small/wemixcoin_color_200.png" alt="" />
